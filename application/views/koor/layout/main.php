...
<head>
    ...
    <link rel="icon" type="image/png" href="<?= base_url('public/assets/img/box.png') ?>">
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        <ul class="navbar-nav bodhy am  sidebar sidebar-dark accordion" id="accordionSidebar">

            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                <div class="sidebar-brand-icon">
                    <img src="<?= base_url('public/assets/img/box.png') ?>" alt="" width="50px">

                </div>
                <div class="sidebar-brand-text mx-3">Proyek</div>
            </a>
