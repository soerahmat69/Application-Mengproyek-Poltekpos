...
<head>
    ...
    <style>
        .bodhy {
            background-image: url('assets/img/bgr.jpg');
                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user" action="<?= base_url('auth/login'); ?>" method="post">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user" id="nim" aria-describedby="email" placeholder="Masukan Nim" name="nim" required>
                                        </div>
                                        <div class="form-group">
